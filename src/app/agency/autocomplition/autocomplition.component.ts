import { Component, ViewChild, EventEmitter, Output, OnInit, AfterViewInit, Input, forwardRef, HostBinding, Self, Optional } from '@angular/core';
import { sharedService } from '../../services/sharedService';
import { ControlValueAccessor, NgControl } from '@angular/forms';
import {TranslateService} from '@ngx-translate/core';
@Component({
  selector: 'autocomplition',
  template: `
  <input class="gmapl"
    type="{{type}}"
  ...
  >
`,
  styleUrls: ['./autocomplition.component.scss']
})
export class AutocomplitionComponent implements  AfterViewInit, ControlValueAccessor {
  ...
  public onTouchedFn = () => { };
  constructor(@Self() @Optional() public control: NgControl,translate: TranslateService) {
